...
a.addCPWStraightLenAng(widthReadout, gapReadout, length = 9000, start = a.prevEnd, startAngleRad = a.prevAngleRad)
a.addCPWAngBend(widthReadout, gapReadout, readoutRadius, -90, a.prevEnd, a.prevAngleRad)
a.addCPWStraightLenAng(widthReadout, gapReadout, length = readoutHeight - launcherHeight - launcherLength - readoutRadius, start = a.prevEnd, startAngleRad = a.prevAngleRad)
...
# Resonator Array
for i in range(0,7):
    a.addCPWStraightLenAng(widthResonator, gapResonator, length = meanderSrtLen, start = [1200*i + 2000, readoutHeight - widthResonator - 2*gapResonator], startAngleRad = -pi)
    a.CPWMeander(widthResonator, gapResonator, 8000+i*500, 150, meanderSrtLen, pi, a.prevEnd, a.prevAngleRad)
